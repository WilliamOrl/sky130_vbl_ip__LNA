...
C {devices/vsource.sym} 510 -220 0 0 {name=vg value="DC 2.5 AC 1" savecurrent=false}
C {devices/gnd.sym} 510 -160 0 0 {name=l3 lab=GND}
C {devices/vsource.sym} 820 -220 0 0 {name=vd value=2.5 savecurrent=false}
...
C {devices/ngspice_get_value.sym} 1010 -290 0 0 {name=r1 node=v(@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[vth])
descr="Vt="}
C {devices/launcher.sym} 940 -410 0 0 {name=h1
descr="load op & annotate" 
tclcommand="xschem raw_read $netlist_dir/techsweep_nfet_g5v0d10v5.raw; set show_hidden_texts 1; xschem annotate_op"}
C {devices/launcher.sym} 940 -450 0 0 {name=h3
descr="save, netlist & simulate"
tclcommand="xschem save; xschem netlist; xschem simulate"}
C {devices/ngspice_get_value.sym} 1010 -250 0 0 {name=r2 node=@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[cgg]
descr="cgg="}
C {devices/ngspice_get_expr.sym} 1120 -210 0 0 {name=r4 
node="[format %.4g [expr [ngspice::get_node \{@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[gm]\}] / [ngspice::get_node \{@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[gds]\}]]]"
descr="gm/gds="}
C {devices/ngspice_get_value.sym} 1010 -210 0 0 {name=r3 node=@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[capbd]
descr="capdb="}
C {devices/ngspice_get_value.sym} 1010 -170 0 0 {name=r5 node=@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[capbs]
descr="capbs="}
C {devices/ngspice_get_expr.sym} 1120 -250 0 0 {name=r6 
node="[format %.4g [expr [ngspice::get_node \{@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[gm]\}] / [ngspice::get_node \{@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[cgg]\}] / 6.283]]"
descr="fT="}
C {devices/ngspice_get_expr.sym} 1120 -290 0 0 {name=r7 
node="[format %.4g [expr [ngspice::get_node \{@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[gm]\}] / [ngspice::get_node \{i(@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[id])\}]]]"
descr="gm/ID="}
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 610 -310 0 0 {name=M1
L=\{lx\}
W=\{wx\}
nf=1 
mult=1
